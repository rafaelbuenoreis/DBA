...
PARTITIONS 4
STORE IN (TB_RH, TB_RH, TB_RH, TB_RH)
LOGGING 
;
...
(PARTITION part1 VALUES LESS THAN (TO_DATE('01/01/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part2 VALUES LESS THAN (TO_DATE('01/02/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part3 VALUES LESS THAN (TO_DATE('01/03/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part4 VALUES LESS THAN (TO_DATE('01/04/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part5 VALUES LESS THAN (TO_DATE('01/05/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part6 VALUES LESS THAN (TO_DATE('01/06/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part7 VALUES LESS THAN (TO_DATE('01/07/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part8 VALUES LESS THAN (TO_DATE('01/08/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part9 VALUES LESS THAN (TO_DATE('01/09/2018', 'DD/MM/YYYY'))  TABLESPACE TB_RH,
 PARTITION part10 VALUES LESS THAN (TO_DATE('01/10/2018', 'DD/MM/YYYY')) TABLESPACE TB_RH,
 PARTITION part11 VALUES LESS THAN (TO_DATE('01/11/2018', 'DD/MM/YYYY')) TABLESPACE TB_RH)
LOGGING 
;
...
CREATE UNIQUE INDEX PEMP_PK ON PEMP (EMPLOYEE_ID ASC) LOCAL;


ALTER TABLE PEMP ADD CONSTRAINT PEMP_PK PRIMARY KEY ( EMPLOYEE_ID ) ;

CREATE INDEX PEMP_DEPARTMENT_IX ON PEMP  ( 
     DEPARTMENT_ID ASC 
    ) 
    LOGGING 
    NOCOMPRESS 
...
begin
	while (l_cnt < l_rows)
	Loop
		insert /*+ APPEND */ into pemp
		select rownum+l_cnt,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,HIRE_DATE,JOB_ID,SALARY,COMMISSION_PCT,MANAGER_ID,DEPARTMENT_ID
		from employees
...
select count(1) from pemp;

-- Carregar a tabela REMP
set serveroutput on size unlimited 		
set verify off
--
declare
...
select sum(bytes)/1024/1024 		MB  	from dba_segments where segment_name = '&_Table_' and owner = '&_OWNER_';
save size.sql replace

@size


EXEC dbms_stats.gather_table_stats(ownname =>'HR', tabname=> 'PEMP', cascade=>TRUE, estimate_percent => 25);
EXEC dbms_stats.gather_table_stats(ownname =>'HR', tabname=> 'REMP', cascade=>TRUE, estimate_percent => 25);
